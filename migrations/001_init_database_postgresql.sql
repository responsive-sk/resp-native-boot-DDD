-- Unified PostgreSQL migration for complete database initialization
-- This migration creates all necessary tables for the blog application using PostgreSQL
