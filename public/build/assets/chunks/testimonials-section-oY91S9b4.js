import{i as o,s as a,a as i,b as s}from"../app.js";class r extends o{static styles=[a,i`
        .container {
            position: relative;
            display: flex;
...
It integrated with Spiral seamlessly, like it was made for it. And now—I actually have a desktop application running on PHP. I couldn’t be happier.`},{name:"Curve (Noah)",pfp:"/images/u/curve.png",role:"Developer of Saucer",comment:"I'm very glad to see projects based on Saucer bindings, and I'm especially excited for Boson as it looks very promising and professionally made, all the best!"}]}get slidesInRandomOrder(){let e=this.slides;for(let t=e.length-1;t>0;t--){const n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}return e}render(){return s`
            <section class="container">
                <div class="content">
                    <slider-component .slides=${this.slidesInRandomOrder}></slider-component>
                </div>
            </section>
        `}}customElements.define("testimonials-section",r);export{r as TestimonialsSection};
