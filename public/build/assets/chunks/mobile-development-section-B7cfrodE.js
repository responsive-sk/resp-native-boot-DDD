import{i as o,s as i,a as n,b as t}from"../app.js";class r extends o{static styles=[i,n`
        .container {
            display: flex;
    ...
    `];get elements(){return[{headline:"Your own protocols",text:`You can intercept any request and process it without raising
                  ...
                  PHP function to call directly from HTML`,icon:"convenient"}]}renderElement(e){return t`
            <div class="element">
                <div class="top">
        ...
        `}}customElements.define("mobile-development-section",r);export{r as MobileDevelopmentSection};
