import{i as s,s as i,a as r,b as n}from"../app.js";class t extends s{static cfg={delay:2e3};static styles=[i,r`
        .container {
            display: flex;
    ...
    `];static properties={activeIndex:{type:Number,state:!0}};constructor(){super(),this.activeIndex=1,this._intervalId=null}connectedCallback(){super.connectedCallback(),this._startAnimation()}disconnectedCallback(){super.disconnectedCallback(),this._stopAnimation()}_startAnimation(){this._intervalId=setInterval(()=>{this.activeIndex=this.activeIndex===4?1:this.activeIndex+1},t.cfg.delay)}_stopAnimation(){this._intervalId&&(clearInterval(this._intervalId),this._intervalId=null)}_getBorderClass(e){const o=[];return this.activeIndex===e&&o.push("border-active"),this.activeIndex===1&&e===2&&o.push("border-top-active"),this.activeIndex===4&&e===3&&o.push("border-top-active"),o.join(" ")}_getSystemClass(e){return this.activeIndex===e?"system system-active":"system"}render(){return n`
        ...
        `}}customElements.define("nativeness-section",t);export{t as NativenessSection};
