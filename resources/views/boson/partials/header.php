<boson-header>
    ...
    <boson-dropdown>
        ...
        <boson-button type="ghost" href="/docs/latest/introduction">
            <img src="/images/icons/book.svg" alt="" aria-hidden="true" width="16" height="16" />
            Introduction
        </boson-button>

        <boson-button type="ghost" href="/docs/latest/installation">
            <img src="/images/icons/download.svg" alt="" aria-hidden="true" width="16" height="16" />
            Installation
        </boson-button>

        <boson-button type="ghost" href="/docs/latest/getting-started">
            <img src="/images/icons/play.svg" alt="" aria-hidden="true" width="16" height="16" />
            Getting Started
        </boson-button>
    </boson-dropdown>
    ...
    <boson-button type="ghost" slot="aside" href="/docs/latest/installation">
        Get Started
        <img src="/images/icons/arrow_up_right.svg" alt="arrow_up_right" width="16" height="16" />
    </boson-button>
